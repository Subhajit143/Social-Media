...
const Card = (prop) => {
  return (
    <>
       <div className="flex ">
<div className=" p-4 flex place-content-center  mt-8 mb-8  ml-20">
  <div className="bg-white border rounded-sm w-[510px] ">
    <div className="flex items-center px-4 py-3">
      <img className="h-8 w-8 rounded-full" src={girl1}/>
      <div className="ml-3 ">
